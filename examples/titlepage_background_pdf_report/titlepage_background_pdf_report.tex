...
\definecolor{titlepageTextColor}{HTML}{116656}
...
\node[inner sep=0pt] at (current page.center){\includegraphics[width=\paperwidth,height=\paperheight]{src/img/title\_page.png}};


% add main logo % TODO: add else
\node[inner sep=0pt] at (page cs:0.672,0.795){\includegraphics[height=0.126\paperheight]{src/icon/MPILogoGreen.eps}};
