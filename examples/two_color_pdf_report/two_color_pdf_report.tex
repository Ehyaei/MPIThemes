...
\definecolor{titlepageTopColor}{HTML}{FFFFFF}

 % when we use titlepage-background do not set this!
\definecolor{titlepageBottomColor}{HTML}{DDDED6}


\definecolor{titlepageTextColor}{HTML}{706d6e}

\definecolor{titlepageAuthorTextColor}{HTML}{116656}
...
\node[inner sep=0pt] at (page cs:0.672,-0.795){\includegraphics[height=0.126\paperheight]{src/icon/MPIBCGreen.eps}};
...
\node[below,text width=\paperwidth,font=\color{titlepageTextColor}] at (page cs:0.0+\titleHjust,0.0+\titleVjust) {
  ...
  % add bodoni font to date
    \huge{\uppercase{01 September, 2021}}
  \vspace{0.3cm}
