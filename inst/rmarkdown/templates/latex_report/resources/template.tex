...
\newtcbtheorem[auto counter,number within=section]{Remark}{Remark}{%
                lower separated=false,fonttitle=\bfseries,
                colback=MPIPink!20!white,colframe=MPIPink,
...
\newtcbtheorem[auto counter,number within=section]{Proof}{Proof}{%
                lower separated=false,fonttitle=\bfseries,
                colback=MPILivingCoral!20!white,colframe=MPILivingCoral,
...
\newtcbtheorem[auto counter,number within=section]{Solution}{Solution}{%
                lower separated=false,fonttitle=\bfseries,
                colback=MPIPacificCoast!20!white,colframe=MPIPacificCoast,
...
$if(banner-logo)$\includegraphics[height=0.06\paperheight]{$banner-logo$}$endif$
};
...
\node[inner sep=0pt] at (page cs:0.672,0.795){$if(logo-primary)$\includegraphics[height=0.126\paperheight]{$logo-primary$}$endif$};
% add secondary logo % TODO: add else
\node[inner sep=0pt] at (page cs:0.672,-0.795){$if(logo-secondary)$\includegraphics[height=0.126\paperheight]{$logo-secondary$}$endif$};
...
$if(preface-logo)$
\begin{center}
\includegraphics[width=2cm]{$preface-logo$}
\end{center}
$endif$
$endif$
...
$if(banner-color)$
\ClearShipoutPicture
\AddToShipoutPicture{\BannerPageHeader\BannerPageFooter}
$endif$
