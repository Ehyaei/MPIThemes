...
\node[below,text width=\paperwidth,font=\color{titlepageTextColor}] at (page cs:0.15+\titleHjust,0.6+\titleVjust) {
  $if(title)$
...
\node[below,text width=\paperwidth,font=\color{titlepageTextColor}] at (page cs:0.15,-0.82) {
  $if(author)$
