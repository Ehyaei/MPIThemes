...
% add rule
\path [fill=titlePageRuleColor] (page cs:1,0.5) rectangle (page cs:-1,0.5+\titlepageRuleHeight);
$endif$
%......................................................................%
...
\node[below,text width=\paperwidth,font=\color{titlepageTextColor}] at (page cs:0.15,-0.87) {
  $if(author)$
  \huge{\textsf{$for(author)$\textcolor{white}{$author$}$sep$\textcolor{white}{,} $endfor$}}
  \vspace{0.3cm}
  $endif$
};
